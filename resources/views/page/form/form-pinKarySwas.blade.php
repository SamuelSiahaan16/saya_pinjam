<x-template title="Pinjaman untuk Karyawan Swasta">
            ...
            <div class="full-grid">
                <form id="main-form">
                    ...
                    <div class="billing-fields">
                        <div class="checkout-title">
                            <h3>Pekerjaan</h3>
                            <input id="type_loan" name="type_loan" class="form-control-mod" value="Guru PNS" type="text"
                                hidden>
                        </div>
                        <div class="form-content-box">
                            <div class="row">
                    ...
                    <div class="payment-method mt-40 md-mt-20">
                        <div class="bottom-area">
                            <button class="btn-shop orange-color" id="submit_form"
                                onclick="handle_save('#submit_form','#main-form','{{ route('store-karyawan-swasta')}}','POST','Kirim Permintaan');"
