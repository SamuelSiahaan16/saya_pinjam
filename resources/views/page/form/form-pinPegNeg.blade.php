<x-template title="Pinjaman untuk Pegawai Negri">
            ...
            <div class="full-grid">
                <form id="main-form">
                    ...
                    <div class="billing-fields">
                        <div class="checkout-title">
                            <h3>Pekerjaan</h3>
                            <input id="type_loan" name="type_loan" class="form-control-mod" value="Pegawai Negeri"
                                type="text" hidden>
                        </div>
                        <div class="form-content-box">
                            <div class="row">
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input id="company_name" name="company_name" class="form-control-mod"
                                            type="text" required>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input id="work_duration" name="work_duration" class="form-control-mod"
                                            type="text" required>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <label>Posisi *</label>
                                        <input id="position" name="position" class="form-control-mod" type="text"
                                            required>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input id="institution" name="institution" class="form-control-mod" type="text"
                                            required>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="payment-method mt-40 md-mt-20">
                        <div class="bottom-area">
                            <button class="btn-shop orange-color" id="submit_form"
                                onclick="handle_save('#submit_form','#main-form','{{ route('store-pinjaman-pegawai-negri')}}','POST','Kirim Permintaan');"
