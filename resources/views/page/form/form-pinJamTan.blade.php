<x-template title="Pinjaman untuk Agunan Sertifikat">
            ...
            <div class="full-grid">
                <form id="main-form">
                    ...
                    <div class="billing-fields">
                        <div class="checkout-title">
                            <h3>Agunan</h3>
                            <input id="type_loan" name="type_loan" class="form-control-mod" value="Agunan Sertifikat"
                                type="text" hidden>
                        </div>
                        <div class="form-content-box">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <select name="certificate_type" id="certificate_type">
                                            ...
                                            <option value="Sertifikat Tanah Berbentu Girik">Sertifikat Tanah Berbentu
                                                Girik</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input id="property_address" name="property_address" class="form-control-mod"
                                            type="text">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="payment-method mt-40 md-mt-20">
                        <div class="bottom-area">
                            <button class="btn-shop orange-color" id="submit_form"
                                onclick="handle_save('#submit_form','#main-form','{{ route('store-jaminan-tanah')}}','POST','Kirim Permintaan');"
